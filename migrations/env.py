"""Entorno Alembic (async) para sward-ms-integracion-lms.

- La URL se toma de `settings.database_url` (postgresql+asyncpg), igual que la app.
- `version_table = alembic_version_integracion_lms`: cada microservicio versiona
  por separado, de modo que conviven en la BD compartida de dev sin pisarse, y en
...
VERSION_TABLE = "alembic_version_integracion_lms"
